package com.haruhara.liveat500px.dao;
...
public class PhotoItemDao  {
    ...
    @SerializedName("aperture")         private String apertuer ;
    ...
    public String getApertuer() {
        return apertuer;
    }

    public void setApertuer(String apertuer) {
        this.apertuer = apertuer;
    }
}
